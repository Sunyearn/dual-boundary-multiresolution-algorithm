function [real_big_edge_boundary,real_big_edge_inside,real_big_edge_useful,real_big_edge_not_useful]=...
    ...
    edge_x_big_control(left_pos_at_big:right_pos_at_big,(forward_pos_at_big+1):backward_pos_at_big) = 20;
...
%     edge_x_big_control(left_pos_at_big:right_pos_at_big,(forward_pos_at_big):(backward_pos_at_big+1) ) = 20;
    ...
    real_big_edge_x_inside = find( edge_x_big_control == 10 );
    real_big_edge_x_useful = find( edge_x_big_control < 20 );
    real_big_edge_x_not_useful = find( edge_x_big_control == 20 );
    %% Y big
    ...
    edge_y_big_control((left_pos_at_big+1):right_pos_at_big,forward_pos_at_big:backward_pos_at_big) = 20;
...
%     edge_y_big_control((left_pos_at_big):(right_pos_at_big+1),forward_pos_at_big:backward_pos_at_big) = 20;
    ...
    real_big_edge_y_inside = find( edge_y_big_control == 10 );
    real_big_edge_y_useful = find( edge_y_big_control < 20 );
    real_big_edge_y_not_useful = find( edge_y_big_control == 20 );
    % adjust
